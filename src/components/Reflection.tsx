...
export default function Reflection() {
  return (
    <section 
      className="relative w-full min-h-[600px] md:min-h-[900px] flex items-start bg-cover bg-[center_20%]" 
      style={{ backgroundImage: "url('/assets/reflection.PNG')" }}
    >
      <div className="relative w-full max-w-7xl mx-auto px-6 py-20 md:py-0 md:pt-[15%] lg:pt-[20%]">
        {/* The md:pt-[20%] above is what pushes the text down on desktop */}
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <a href="mailto:jatin15@hotmail.co.uk" className="inline-block text-[#0a2f14] hover:text-[#258c3d] mt-1">
